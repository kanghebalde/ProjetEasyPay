			...
			<div class="content-wrapper">
				...
				<div class="content">
					...
					<div class="col-md-12">
							...
							<!-- Advanced legend -->
							<form  action="easypay/uploadAgence">
								<div class="panel panel-flat">
									<div class="panel-heading">
					                	...
					                	<h4><i class=" position-left"></i> <span class="text-semibold">Bienvenue Admin !</span></h4>
											...
											<div class="collapse in" id="demo1">
												<div class="col-md-5">
													<div class="form-group">
														<input type="text"  hidden="hidden"  name="responsable" id="responsable" value="<%=a.getResponsable() %>" placeholder="">
															<input type="text"  hidden="hidden"  name="id" id="id" value="<%=a.getId() %>" placeholder="">
														<input type="text" class="form-control" name="nom" id="nom" value="<%=a.getNomagence() %>" required="required" placeholder="">
											...
											<div class="collapse in" id="demo2">
						                		...
						                		<div class="col-md-5">
													<div class="form-group">
							                        	...
							                        	<input type="text" class="form-control" name="tel" id="tel" value="<%=a.getTel() %>" required="required" placeholder="">
						                		...
						                		<div class="col-md-5">        
													<div class="form-group">
							                        	...
							                        	<input type="text" class="form-control" name="tel2" id="tel2" value="<%=a.getTel2() %>" required="required" placeholder="">
							                        	<span class="help-block">&nbsp;&nbsp;06 - 55555555</span>
													</div>							
												...
												<div class="col-md-5">
													<div class="form-group">
							                        	...
							                        	<input type="text" class="form-control" name="fax" id="fax" required="required"  value="<%=a.getFax() %>"placeholder="">
							                        	<span class="help-block">&nbsp;&nbsp;06 - 55555555</span>
													</div>			
												</div>
												<div class="col-md-5">
													<div class="form-group">
														...
														<input type="email" name="email" class="form-control" id="email" value="<%=a.getEmail() %>" required="required" placeholder="">
						...
						<div class="col-md-10">
							...
							<div class="form-group">
										...
										<label>Adresse:</label>
										<input type="text" class="form-control" id="us2-address" name="us2-address" value="<%=a.getAdresse() %>" required="required">
									</div>
								</div>
...
<div class="col-md-5">
									<div class="form-group">
										<label>Ville</label>
										<input type="text" class="form-control" id="ville" value="<%=a.getVille() %>" name="ville">
									</div>
</div>			
<div class="col-md-5">
									<div class="form-group">
										<label>Rayon:</label>
										<input type="text" class="form-control" id="us2-radius"  value="<%=a.getRayon() %>" name="us2-radius">
									</div>
</div>
...
<div class="col-md-5">
									<div class="form-group">
										...
										<input type="text" class="form-control" id="us2-lat" value="<%=a.getLatitude() %>" name="us2-lat">
									</div>
									</div>
<div class="col-md-5">
									<div class="form-group">
										<label>Longitude:</label>
										<input type="text" class="form-control" id="us2-lon" value="<%=a.getLongitude() %>" name="us2-lon">
									</div>
									</div>
										...
										<div class="text-right">
											<button type="submit" name="etape1" id="etape1" class="btn btn-primary">Modifier <i class="icon-arrow-right14 position-right"></i></button>
										</div>
									</div>
								</div>
							</form>
