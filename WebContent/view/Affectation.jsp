...
<% List<Agence> listeagence =(List<Agence>)(request.getAttribute("listagence")); 
List<User> listeUser =(List<User>)(request.getAttribute("listuser")); 
			...
			<div class="content-wrapper">
				...
				<div class="content">
					...
					<div class="col-md-12">
							...
							<!-- Advanced legend -->
							<form  action="easypay/addAffectation">
									...
									<div class="panel-body">
										<fieldset>
											<legend class="text-semibold">
												...
												Veuillez séléctionner le nom de l'agence et le responsable
											...
											<div class="collapse in" id="demo1">
			                					...
			                					<div class="form-group">
													<label>Veuillez séléctionner le nom de l'agence </label>
				                                    <select data-placeholder="" name="nomagence" id="nomagence" class="select">
				                                    <% for( Agence t : listeagence){ %>
							                		...
							                		<div class="col-md-6">
		                					<div class="form-group">
													<label>Veuillez séléctionner le responsable</label>
				                                    <select data-placeholder="" name="nomres" id="nomres" class="select">
				                                    <% for( User t : listeUser){ %>
