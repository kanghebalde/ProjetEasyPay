...
<% List<User> listes =(List<User>)(request.getAttribute("listclient")); 
						...
						<table class="table datatable-fixed-left" width="100%">
						    ...
						    <tbody>
						        ...
						        <tr>
					                ...
					                <td><%=t.getAdresse() %></td>
						            <th>
						            <% if(t.getApprouve().equals("oui")) {%>
						            	<ul class="icons-list">
												<li class="text-primary-600"><a href=""><i class="icon-user-check"></i></a></li>												
											</ul>
											
									<%} else { %>
										<ul class="icons-list">
						            	<%String app = "easypay/$"+t.getId()+"$/ApprouverClient";						 
						            	%>
												<li class="text-danger-600"><a href="<%=app%>"><i class="icon-checkmark4"></i></a></li>
